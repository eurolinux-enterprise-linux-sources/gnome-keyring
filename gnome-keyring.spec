...
* Tue Mar 18 2014 Zeeshan Ali <zeenix@redhat.com> - 3.8.2-7
- Fix issue with changed password not unlocking keyring (related: rhbz#1075715).

* Tue Mar 11 2014 Zeeshan Ali <zeenix@redhat.com> - 3.8.2-6
- daemon: Exit gnome-keyring-daemon when the DBus connection
  closes (related: rhbz#1030671).
...
* Wed Nov  6 2013 Matthias Clasen <mclasen@redhat.com> - 3.8.2-3
- Add man pages
- Resolves: #948922
